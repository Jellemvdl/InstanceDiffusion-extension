...
In the image below, we present two random samples generated by using either points or scribbles as input and compare them with the original image used as ground truth. As expected, using scribbles as input is the cause for slightly better results when compared to using points as input. 
...
![image](https://github.com/Jellemvdl/InstanceDiffusion-extension/src/data/images/LLM/ratings_freq.png)
...
<div style="display: flex; justify-content: space-between;">
  <div style="text-align: center; margin: 10px;">
    <img src="https://github.com/Jellemvdl/InstanceDiffusion-extension/src/data/images/LLM/poor_image.png" alt="Poor Quality Image" style="width: 500px;"/>
    <p>Poor Quality Image</p>
  </div>
  <div style="text-align: center; margin: 10px;">
    <img src="https://github.com/Jellemvdl/InstanceDiffusion-extension/src/data/images/LLM/medi_image.png" alt="Medium Quality Image" style="width: 500px;"/>
    <p>Medium Quality Image</p>
  </div>
  <div style="text-align: center; margin: 10px;">
    <img src="https://github.com/Jellemvdl/InstanceDiffusion-extension/src/data/images/LLM/good_image.png" alt="Good Quality Image" style="width: 500px;"/>
